<?php
/**
 * Customise the default land search to a single drop down in the search widget/shortcode
 *
 */

function my_epl_add_single_land_search_dropdown_field($fields) {
...
add_filter('epl_search_widget_fields_frontend','my_epl_add_single_land_search_dropdown_field');
