 ...
 *
 */
function my_add_to_end_of_array( $existing_array ) {
 ...
 *
 */
function my_add_to_beginning_of_array( $existing_array ) {
...
/**
 * Add a new item to the beginning of an existing array. (Another way)
 *
 * Using epl_widget_listing_property_status asn an example in
 * https://github.com/easypropertylistings/Easy-Property-Listings/blob/master/lib/widgets/class-epl-widget-recent-property.php
 *
 */
function my_add_to_beginning_of_array_another_way( $existing_array ) {

	$new_fields = [
		'coming_soon' => 'Coming Soon'
	];

	$existing_array = $new_fields + $existing_array;
